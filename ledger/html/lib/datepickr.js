...
datepickr.init = function (element, instanceConfig) {
    ...
    buildMonthNavigation = function () {
        ...
        monthNavigation += '<span class="datepickr-prev-year"> &lt;&lt; </span>';
        monthNavigation += '<span class="datepickr-next-month">&gt;</span>';
        monthNavigation += '<span class="datepickr-next-year"> &gt;&gt; </span>';
    ...
    calendarClick = function (event) {
        ...
        if (targetClass) {
            if (targetClass === 'datepickr-prev-year' || targetClass === 'datepickr-next-year') {
                if (targetClass === 'datepickr-prev-year') {
                    self.currentYearView--;
                } else {
                    self.currentYearView++;
                }
            ...
            } else if (targetClass === 'datepickr-prev-month' || targetClass === 'datepickr-next-month') {
