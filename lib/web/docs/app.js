...
let Docs = {
    ...
    `,
    data() {
        return {srcIdx:'', fetchStatIdx:500, srcDir:'', fetchStatDir:500}
    },
    mounted() {
        //this.loadIndexFile();
    },
    computed: {
    ...Vuex.mapState('Docs', ['s_mdDir', 's_mdFile', 's_server', 's_isfossil']),
    },
    methods: {
...
Vue.component('jsi-nav-bar', {
    template:`
<div>
  <b-sidebar v-if="s_websock" id="jsi_sidebar" bg-variant="info" title="Docs Menu">
    <b-nav vertical>
      <b-navbar-nav class="mx-2 my-0 py-0">
        <b-nav-item link-classes="py-1" href="#" @click="menuCmd('exit')" :disabled="false" title="Notify jsish server to exit">Exit</b-nav-item>
      </b-navbar-nav >
    </b-nav">
  </b-sidebar>
  ...
  <b-navbar  class="p-1">
    <b-navbar-nav >
      <b-nav-form class="d-inline-flex">
        <b-nav-item v-if="s_websock" id="pdq_menubut2" class="" style="margin-bottom:-3px" v-b-toggle.jsi_sidebar>&#9776;</b-nav-item>
        <b-button size="sm" class="my-2 my-sm-0" class="pdq-nav-area"><a href="https://jsish.org" target="_blank" title="jsish.org home page">JSI</a></b-button>
      </b-nav-form>
      <b-nav-item href="#" @click="goTo('Start.md')" :disabled="s_mdFile=='Start.md'" >Start</b-nav-item>
      <b-nav-item href="#" @click="goTo('Reference.md')" :disabled="s_mdFile=='Reference.md'">Reference</b-nav-item>
      <b-nav-item href="#" @click="goTo('Index.md')" :disabled="s_mdFile=='Index.md'" >Index</b-nav-item>
    </b-navbar-nav>
    ...
    <b-navbar-nav class="ml-auto">
        <b-nav-form class="d-inline-flex">
          ...
          <b-button size="sm" class="w-1" title="Toggle hide-submenus" @click="subChange" v-html="subShowLabel"></b-button>
         </b-nav-form>
...
let histmode = (location.port<=999);
let DocsStore = {
    //strict:true,
    namespaced:true,
    state: {
        s_mdDir:(histmode?'/md/':'../md/'),
        s_mdFile:null,
        s_mdList:[],
        s_mdToc:null,
        s_mdAncs:null,
