...
Vue.component('jsi-left-menu-item', {
    ...
    computed:
        ...
        getDisplay:function() { return true; },
        }),
});
    ...
    computed:  Object.assign(
        ...
        getDisplay:function() {
            if (this.s_showAllSub)
                return true;
            var ca = this.s_curAnc, cp = this.s_curAncParent, mitem = this.mitem,
  ...
  <b-row rows="1" class="bg-navbar bd-navbar">
    ...
    methods: 
       Object.assign(
        ...
        setupAncs:function(c) { // Update s_ancChain on scroll.
