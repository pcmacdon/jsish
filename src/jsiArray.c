...
static Jsi_CmdSpec arrayCmds[] = {
    ...
    { "filter",     jsi_ArrayFilterCmd,     1, 2, "callback:function, thisArg:object=void", .help="Return a filtered array", .retType=(uint)JSI_TT_ARRAY },
    ...
    { "forEach",    jsi_ArrayForeachCmd,    1, 2, "callback:function, thisArg:object=void", .help="Invoke function with each item in object", .retType=(uint)JSI_TT_VOID },
    ...
    { "map",        jsi_ArrayMapCmd,        1, 2, "callback:function, thisArg:object=void", .help="Creates a new array with the results of calling a provided function on every element in this array", .retType=(uint)JSI_TT_ARRAY },
    ...
    { "some",       jsi_ArraySomeCmd,       1, 2, "callback:function, thisArg:object=void", .help="Return true if function returns true some element", .retType=(uint)JSI_TT_BOOLEAN },
